...
function Books({language}) {
    ...
    fr: {
        title: "Mes Livres Universitaires (Licence)",
    ...
    es: {
        title: "Mis Libros Universitarios (Licenciatura)",
    ...
    ru: {
        title: "Мои Университетские Книги (Бакалавриат)",
    ...
    ar: {
        title: "كتبي الجامعية (البكالوريوس)",
