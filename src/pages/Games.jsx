    ...
    <div className="page">
        ...
        {page === 2 && (
            <div className="game-card">
                ...
                <a href="https://www.google.com" target="_blank" rel="noopener noreferrer"><button className="game-button" onClick={() => { stopMusic(); playClick(); }}>{gamesText[language].chessButton}</button></a>
            </div>
        )}
